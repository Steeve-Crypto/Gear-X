...
Expo Router owns navigation through thin route exports/layouts; feature controllers own screen workflows; repositories own SQL; adapters own providers; services coordinate use cases; screens render state.
...
## Acceptance criteria
No monolithic App; route files contain no repository/provider business logic; the feature tree is scalable; agent and data paths have typed contracts; checks pass.
## Dependencies
